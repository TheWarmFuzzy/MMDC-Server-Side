<?php
	...
	defined("ALLOW_TABLE_CREATION") or define("ALLOW_TABLE_CREATION",isset($constants["ALLOW_TABLE_CREATION"]) ? $constants["ALLOW_TABLE_CREATION"]["VALUE"]: false);
	defined("ALLOW_AUTO_TABLE_CREATION") or define("ALLOW_AUTO_TABLE_CREATION",isset($constants["ALLOW_AUTO_TABLE_CREATION"]) ? $constants["ALLOW_AUTO_TABLE_CREATION"]["VALUE"]: false);
	defined("ALLOW_TABLE_DROP") or define("ALLOW_TABLE_DROP",isset($constants["ALLOW_TABLE_DROP"]) ? $constants["ALLOW_TABLE_DROP"]["VALUE"]: false);
	...
	defined("DEBUG") or define("DEBUG", isset($constants["DEBUG"]) ? $constants["DEBUG"]["VALUE"]: false);
